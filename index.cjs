'use strict';
// Narodowy Bank Polski exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/nbp';
...
/** Latest rate for one pair, e.g. getRate('EUR', 'PLN', { apiKey }). */
